    ...
    <div className="navbar bg-base-300 w-full  ">
      <div className="navbar-start w-full">
        ...
        <Link className=" flex items-center justify-center " to={"/"}>
          <img src={img} className=" w-[45px] h-[45px] border-none " alt="" />
          <p className="button text-2xl font-mono">{t("Internet")}</p>
        </Link>
      </div>

      <div className="navbar-center relative right-[300px]  hidden lg:flex ">
        {navLinks.map((item, idx) => {
          return (
            <div key={idx} className="w-[70px] flex-none gap-10">
      ...
      <div className="navbar-end flex gap-3">
        <div>
          <select onChange={handleChange} className="lang-select font-mono">
